...
<?php include_once "../connect2db.inc"; ?>
    ...
    <div class="w3-card-4 w3-white w3-margin">
        ...
        <!-- Verhaal Formulier -->
        <form class="w3-padding" method="post" action="save_dagboek.php">
        <div class= "w3-padding">
            <label><b>Onderwerp</b></label>
            <input class ="w3-input w3-border" type="text" name="frmOnderwerp" id="frmOnderwerp">
        </div>
        
        <div class="w3-padding">
            <label><b>Verhaal</b></label>
            <textarea class="w3-input w3-border" name="frmVerhaal" id="frmVerhaal" rows="10"></textarea>
        </div>

        <div class="w3-row" style="align-items: baseline;">
            <div class="w3-padding w3-half w3-left">
            ...
            <div class="w3-padding w3-half w3-right">
                <a href="dagboek.php" id="terug-button" class="w3-button w3-round w3-margin-bottom w3-right">Terug</a>
            </div>
        </div>
        </form>
    </div> 
