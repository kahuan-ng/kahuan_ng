...
<head>
    ...
    <link rel="stylesheet" href="edit_registratie.css" type="text/css">
</head>
    ...
    <div class="w3-container">
        <div class="w3-card-4 w3-white w3-display-middle w3-row" style="max-width: 600px;">
            ...
            <div class="w3-padding w3-center">
                <a href="beighton_resultaat_overzicht.php" class="w3-button w3-indigo w3-round">Beighton Resultaten</a>
            </div>
