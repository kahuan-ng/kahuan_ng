    ...
    <div class="w3-content w3-padding" style="max-width:800px;">
        ...
        ?>
            <div class="w3-card-4 w3-white w3-margin-bottom w3-padding">
                ...
                <p class="w3-text-black">Door: <strong><?php echo htmlspecialchars($verhaal['naam_verhaal']); ?></strong></p>
                <span class="w3-small w3-text-grey">(<?php echo date('d/m/Y H:i', strtotime($verhaal['datum'])); ?>)</span>
                <p><?php echo nl2br(htmlspecialchars($verhaal['verhaal'])); ?></p>

                <!-- Reacties tonen -->
                <div class="w3-container w3-light-grey w3-padding w3-margin-large w3-round">
                    <h4>Reacties:</h4>
                    <?php
                    ...
                    if (mysqli_num_rows($comments) > 0) {
                        while ($comment = mysqli_fetch_array($comments)) {
                            ...
                            echo '<p style="margin:0;"><strong>' . htmlspecialchars($comment['naam_comment']) . '</strong> ';
                            echo '<span class="w3-small w3-text-grey">(' . date('d/m/Y H:i', strtotime($comment['datum_comment'])) . ')</span></p>';
                    
                            if (isset($_SESSION['gebruikersnaam']) && $_SESSION['gebruikersnaam'] === $comment['naam_comment']) {
                ...
                <!-- Knoppen container: reageer links, delete rechts -->
                <div class="w3-margin-top" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <?php if (isset($_SESSION['gebruikersnaam']) && $_SESSION['gebruikersnaam'] === $verhaal['naam_verhaal']): ?>
                ...
                <?php else: ?>
                    <div class="w3-margin-top">
                        <a href="aanmelden.php" class="w3-button w3-small w3-round w3-red">
