...
<body>
    <div class="w3-bar w3-teal w3-large w3-top">
        <form method="GET" class="w3-bar-item w3-input" style="display:inline;" action="landendb_2.php">
    ...
    <table class="w3-table w3-striped w3-hoverable"> 
        ...
        ?>
        <tr class="w3-hover-shadow-large w3-hover-opacity" onclick="window.location='detail.php?code=<?php echo $land['code']; ?>';" style="cursor: pointer;">
            <td><?php echo $land["naam"]; ?></td>
            <td><?php echo $land["hoofdstad"]; ?></td>
            <td><?php echo $land["code"]; ?></td>
            <td><img src="https://flagcdn.com/w640/<?php echo strtolower($land["code"]); ?>.png" style="height: 20px;"></td>
        </tr>
    <?php
        }
    ?>
